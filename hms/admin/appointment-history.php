...
<html lang="en">
	...
	<head>
		<title>Пациенты | История приёмов</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Пациенты  | История приёмов</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Пациенты </span>
						...
						<div class="row margin-bottom-20">
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
										<?php
										$sql = mysqli_query($con, "SELECT d.doctorName as docname,
                                            tbl.PatientName as pname,
                                            a.*,
                                            ds.doctorSpecialization
                                        FROM appointment a
                                        JOIN doctors d ON d.id = a.doctorId
                                        JOIN tblpatient tbl ON tbl.ID = a.userId
