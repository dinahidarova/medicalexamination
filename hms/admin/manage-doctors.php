...
<html lang="en">
	<head>
		<title>Админ | Управление врачами</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Админ | Управление врачами</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Админ</span>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Управлять <span class="text-bold">врачами</span></h5>
									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												<th class="center">№</th>
												<th>Специализация</th>
												<th class="hidden-xs">ФИО врача</th>
										...
										<tbody>
<?php
$sql = mysqli_query($con, "SELECT d.*, s.doctorSpecialization 
    FROM doctors d 
    JOIN doctorspecilization s ON d.doctorSpecializationId = s.doctorSpecializationId");
