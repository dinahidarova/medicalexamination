                                ...
                                <table class="calendar">
                                    ...
                                    <tbody>
                                        ...
                                        for($day = 1; $day <= $daysInMonth; $day++) {
                                            ...
                                            $isToday = ($date == date('Y-m-d')) ? 'font-weight-bold text-primary' : '';
                                            
                                            echo '<td>';
                                            echo '<div class="day-number '.$isToday.'">'.$day.'</div>';
                                            ...
                                            if(isset($appointments[$date])) {
                                                foreach($appointments[$date] as $app) {
                                                    ...
                                                    echo '<div class="appointment '.$ageClass.'">';
                                                    echo '<strong>'.$app['PatientName'].'</strong><br>';
                                                    echo date('H:i', strtotime($app['appointmentTime'])).'<br>';
                                                    echo $app['age'].' лет';
                                                    echo '</div>';
                                                }
                                            }
